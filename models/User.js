...
User.prototype.validate = function() {
    return new Promise(async (resolve, reject) => {
        ...
        if (this.data.password.length > 0 && this.data.password.length < 12) {this.errors.push("Password must be at least 12 character long.")}
...
User.prototype.register = function() {
    return new Promise(async (resolve, reject) => {
        ...
        //Step 2 Only is there are no validation errors then save user data into database 
